              ...
              <div className="flex flex-col gap-11">
                <div className="flex flex-col gap-5 ">
                  ...
                  <p className="max-w-2xl text-secondary/70 dark:text-white/70">
                    ...
                    in global trade compliance, product sourcing, quality
                    assurance, documentation, and logistics execution. From
                    vendor development and sustainable packaging to customs
                    coordination and client relationship management, our people
                    ensure every shipment moves reliably, transparently, and on
                    schedule while opening new markets for our partners.
                  </p>
                </div>
              </div>
            </div>
