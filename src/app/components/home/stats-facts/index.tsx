...
function StatsFacts() {
  ...
  return (
    <section className="relative bg-white dark:bg-secondary overflow-hidden">
      <div className="relative py-20 md:py-40 z-10">
        <div className="container">
          <div className="flex flex-col xl:flex xl:flex-row items-start gap-8">
            <div className="flex flex-col gap-5 2xl:gap-7 w-full 2xl:max-w-2xl 2xl:w-full items-start">
              ...
              <Image
                src={"/images/home/statsfact/stats-facts.jpg"}
                alt="image"
                height={0}
                width={400}
                objectFit="contain"
      ...
      {/* <div className="hidden lg:block absolute bottom-20 left-38">
                <Image
                    src={"/images/home/statsfact/stats-facts.jpg"}
                    alt="image"
                    height={"100"}
      ...
      <div className="absolute -bottom-28 -left-20 lg:hidden">
        <Image
